            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Account verification to reset password </h5>
                    <p class="text-center small">We just sent you a verification code. Enter it below to reset your password</p>
                  </div>

                  <form class="row g-3 needs-validation" method="POST" action="verificationcodemdp.php">
                   <div class="col-12">
                      <label for="code" class="form-label">Verification Code</label>
                      <input type="text" name="Codemdp" class="form-control" id="yourcode" placeholder="Enter code" required>
                      <div class="invalid-feedback">Please enter a valid code</div>
                    </div>
                   
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit">Verify to reset Password</button>
                      <?php
